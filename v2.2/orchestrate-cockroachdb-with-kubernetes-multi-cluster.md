...
summary: How to use Kubernetes to orchestrate the deployment, management, and monitoring of a secure CockroachDB cluster across multiple Kubernetes clusters in different regions.
toc: true
